            ...
            <div class="col-md-9 col-xs-12">
               <article>
                  <div class="embed-responsive embed-responsive-16by9">
                     <iframe class="embed-responsive-item" src="https://player.vimeo.com/video/172825105?color=be9a67&title=0&byline=0&portrait=0"></iframe>   
                  </div>
                  <div class="text-block-wrapp text-left color-type-2">
                     <div class="empty-sm-30 empty-xs-10"></div>
                     <h4 class="h4 tt color-type-1"><a href="#" class="title-blog">Amazing master class from our chef guest</a></h4>
                     ...
                     <div class="simple-text">
                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor inc ididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco  laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit</p>
                     </div>
                     <div class="empty-sm-30 empty-xs-20"></div>
                     <a href="#" class="page-button button-style-1 type-2"><span class="txt">Read more</span></a>
                     <div class="blog-info like">
                        <ul>
                           <li>
                              <div class="inline icon">
                                 <a href="">
                                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 471.701 471.701" style="enable-background:new 0 0 471.701 471.701;" xml:space="preserve" width="18px" height="18px">
                                       <g>
                           ...
                           <li>
                              <div class="inline icon">
                                 <a href="">
                                    <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="18px" height="18px" viewBox="0 0 511.626 511.627" style="enable-background:new 0 0 511.626 511.627;"
                                       xml:space="preserve">
                                       <g>
               ...
               <article>
                  <div class="video-open">
                     <img src="img/blog/video-bg-2.jpg" alt="" class="full-img">
                  ...
                  <div class="text-block-wrapp text-left color-type-2">
                     <div class="empty-sm-30 empty-xs-10"></div>
                     <h4 class="h4 tt color-type-1"><a href="#" class="title-blog">New discovered recipe for the strudel</a></h4>
                     <div class="empty-sm-20 empty-xs-10"></div>
                     <div class="blog-info">
                        <ul>
                           <li>
               ...
               <article>
                  <div class="menu-item menu-item-2 color-type-1">
                     <div class="swiper-container full-h animation-2" data-mode="horizontal" data-autoplay="0" data-effect="slide" data-slides-per-view="1" data-loop="0" data-speed="800">
                        <div class="swiper-wrapper">
                           <div class="swiper-slide">
                              <div class="menu-item menu-item-2 color-type-1">
                                 <img src="img/blog/post-3.jpg" alt="" class="full-img">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="menu-item menu-item-2 color-type-1">
                                 <img src="img/blog/post-3-1.jpg" alt="" class="full-img">
                              </div>
                           </div>
                           <div class="swiper-slide">
                              <div class="menu-item menu-item-2 color-type-1">
                                 <img src="img/blog/post-3-2.jpg" alt="" class="full-img">
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="text-block-wrapp text-left color-type-2">
                     <div class="empty-sm-30 empty-xs-10"></div>
                     <h4 class="h4 tt color-type-1"><a href="#" class="title-blog">Your offers for our restaurant</a></h4>
                     <div class="empty-sm-20 empty-xs-10"></div>
                     <div class="blog-info">
                        <ul>
                           <li>
               ...
               <article>
                  <div class="menu-item menu-item-2 color-type-1 hover-zoom">
                     <a href="#" class="image-hover"><img src="img/blog/post-4.jpg" alt="" class="full-img"></a>
                  </div>
                  <div class="text-block-wrapp text-left color-type-2">
                     <div class="empty-sm-30 empty-xs-10"></div>
                     <h4 class="h4 tt color-type-1"><a href="#" class="title-blog">renovation in our music list</a></h4>
                     <div class="empty-sm-20 empty-xs-10"></div>
                     <div class="blog-info">
                        <ul>
                           <li>
            ...
            <div class="col-md-3 col-xs-12">
               ...
               <aside>
                  ...
                  <ul class="list-style-4 type-2 ul-list">
                     <li><a href="#" class="link-hover">Recipes<span>(34)</span></a></li>
                     <li><a href="#" class="link-hover">Cooks<span>(15)</span></a></li>
                     <li><a href="#" class="link-hover">Customers<span>(13)</span></a></li>
                     <li><a href="#" class="link-hover">Atmosphere<span>(9)</span></a></li>
                     <li><a href="#" class="link-hover">Upcoming Events<span>(11)</span></a></li>
                  </ul>
               </aside>
               <aside>
                  <div class="empty-sm-65 empty-xs-30"></div>
                  <h5 class="tt h5 color-2">Most Popular Posts</h5>
                  <div class="empty-sm-20 empty-xs-10"></div>
                  <div class="recent-post type-2">
                     <div class="img">
                        <div class="menu-item menu-item-2 color-type-1">
                           <a href="#" class="image-hover"><img src="img/blog/popular-post-1.jpg" alt=""></a>
                        </div>
                     </div>
                     <div class="txt">
                        <h6 class="h6 caption"><a href="#" class="link-hover">Lorem ipsum dolor sit amet, consectetur.</a></h6>
                  ...
                  <div class="recent-post type-2">
                     <div class="img">
                        <div class="menu-item menu-item-2 color-type-1">
                           <a href="#" class="image-hover"><img src="img/blog/popular-post-2.jpg" alt=""></a>
                        </div>
                     </div>
                     <div class="txt">
                        <h6 class="h6 caption"><a href="#" class="link-hover">Lorem ipsum dolor sit amet, consectetur.</a></h6>
                  ...
                  <div class="recent-post type-2">
                     <div class="img">
                        <div class="menu-item menu-item-2 color-type-1">
                           <a href="#" class="image-hover"><img src="img/blog/popular-post-3.jpg" alt=""></a>
                        </div>
                     </div>
                     <div class="txt">
                        <h6 class="h6 caption"><a href="#" class="link-hover">Lorem ipsum dolor sit amet, consectetur.</a></h6>
               ...
               <aside>
                  <div class="empty-sm-65 empty-xs-30"></div>
                  <h5 class="tt h5 color-2">lates tweets</h5>
                  <div class="empty-sm-20 empty-xs-10"></div>
                  <div class="f-twitt type-2">
                     <a href="#">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 310 310" style="enable-background:new 0 0 310 310;" xml:space="preserve" width="12px" height="12px">
                           <g id="XMLID_826_">
                              <path id="XMLID_827_" d="M302.973,57.388c-4.87,2.16-9.877,3.983-14.993,5.463c6.057-6.85,10.675-14.91,13.494-23.73   c0.632-1.977-0.023-4.141-1.648-5.434c-1.623-1.294-3.878-1.449-5.665-0.39c-10.865,6.444-22.587,11.075-34.878,13.783   c-12.381-12.098-29.197-18.983-46.581-18.983c-36.695,0-66.549,29.853-66.549,66.547c0,2.89,0.183,5.764,0.545,8.598   C101.163,99.244,58.83,76.863,29.76,41.204c-1.036-1.271-2.632-1.956-4.266-1.825c-1.635,0.128-3.104,1.05-3.93,2.467   c-5.896,10.117-9.013,21.688-9.013,33.461c0,16.035,5.725,31.249,15.838,43.137c-3.075-1.065-6.059-2.396-8.907-3.977   c-1.529-0.851-3.395-0.838-4.914,0.033c-1.52,0.871-2.473,2.473-2.513,4.224c-0.007,0.295-0.007,0.59-0.007,0.889   c0,23.935,12.882,45.484,32.577,57.229c-1.692-0.169-3.383-0.414-5.063-0.735c-1.732-0.331-3.513,0.276-4.681,1.597   c-1.17,1.32-1.557,3.16-1.018,4.84c7.29,22.76,26.059,39.501,48.749,44.605c-18.819,11.787-40.34,17.961-62.932,17.961   c-4.714,0-9.455-0.277-14.095-0.826c-2.305-0.274-4.509,1.087-5.294,3.279c-0.785,2.193,0.047,4.638,2.008,5.895   c29.023,18.609,62.582,28.445,97.047,28.445c67.754,0,110.139-31.95,133.764-58.753c29.46-33.421,46.356-77.658,46.356-121.367   c0-1.826-0.028-3.67-0.084-5.508c11.623-8.757,21.63-19.355,29.773-31.536c1.237-1.85,1.103-4.295-0.33-5.998   C307.394,57.037,305.009,56.486,302.973,57.388z" fill="#FFFFFF"/>
                           </g>
                           <g></g>
                           <g></g>
                           <g></g>
                     ...
                     <a href="#">https://telegram.org/blog/edit </a>
               ...
               <aside>
                  <div class="empty-sm-65 empty-xs-30"></div>
                  <h5 class="tt h5 color-2">Archives</h5>
                  <div class="empty-sm-20 empty-xs-10"></div>
                  <ul class="list-style-4 type-2 ul-list">
                     <li><a href="#" class="link-hover">June, 2016</a></li>
                     <li><a href="#" class="link-hover">May, 2016</a></li>
                     <li><a href="#" class="link-hover">April, 2016</a></li>
                     <li><a href="#" class="link-hover">March, 2016</a></li>
                     <li><a href="#" class="link-hover">February, 2016</a></li>
                  </ul>
               </aside>
               <aside>
                  <div class="empty-sm-65 empty-xs-30"></div>
                  <h5 class="tt h5 color-2">Subscribe</h5>
                  <div class="empty-sm-20 empty-xs-10"></div>
                  <form action="/" onsubmit="return subscribeForm();" method="post" id="subscribe-form" class="subscribe-form flex-align">
